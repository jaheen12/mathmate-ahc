        ...
        <>
            ...
            <div className={`bg-gray-900 text-white w-72 flex flex-col fixed inset-y-0 left-0 transform md:relative md:translate-x-0 transition-transform duration-300 ease-out ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} z-50 border-r border-gray-700`}>
                ...
                <div className="p-4 border-t border-gray-700 space-y-2">
                    <NavLink to="/settings" onClick={toggleSidebar} className={({ isActive }) => `flex items-center py-2.5 px-4 rounded-lg transition-colors duration-150 ${isActive ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'}`}>
                    ...
                    <div className="text-center pt-2">
                        <span className="text-xs text-gray-500">v1.0.0-offline</span>
                    </div>
                </div>
            </div>
        </>
